...
- Workout/exercise session state, metrics, analytics, progress, account/session deletion, dependency readiness checks, and Railway deployment wiring are still pending.
